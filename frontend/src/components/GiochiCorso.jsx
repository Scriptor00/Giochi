...
// import "./GiochiCorso.css"; // Assicurati che questo file CSS esista o che gli stili siano in index.css
                    ...
                    {giochiInCorso.map((gioco) => (
                        <Link to={`/giochi/${gioco.id}`} key={gioco.id} className="gioco-card-link">
                            <div className="gioco-card">
                                ...
                                {gioco.votoPersonale != null && <p className="gioco-card-meta">Voto Personale: {gioco.votoPersonale}/10</p>} 
                            </div>
                        </Link>
                    ))}
                </div>
